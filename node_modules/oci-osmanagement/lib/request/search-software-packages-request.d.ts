...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/1.19.2/osmanagement/SearchSoftwarePackages.ts.html |here} to see how to use SearchSoftwarePackagesRequest.
 */
...
export declare namespace SearchSoftwarePackagesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

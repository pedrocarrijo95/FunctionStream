...
export declare class OceInstanceWaiter {
     ...
     */
    forOceInstance(request: serviceRequests.GetOceInstanceRequest, ...targetStates: models.OceInstance.LifecycleState[]): Promise<serviceResponses.GetOceInstanceResponse | null>;
    /**

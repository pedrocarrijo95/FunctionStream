...
export declare class DatabaseMigrationWaiter {
     ...
     */
    forAgent(request: serviceRequests.GetAgentRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetAgentResponse | null>;
    /**
     ...
     */
    forConnection(request: serviceRequests.GetConnectionRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetConnectionResponse | null>;
    /**
     ...
     */
    forMigration(request: serviceRequests.GetMigrationRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetMigrationResponse | null>;
    /**

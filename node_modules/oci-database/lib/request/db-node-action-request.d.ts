...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/1.19.2/database/DbNodeAction.ts.html |here} to see how to use DbNodeActionRequest.
 */
...
export declare namespace DbNodeActionRequest {
    enum Action {
        Stop = "STOP",
        Start = "START",
        Softreset = "SOFTRESET",

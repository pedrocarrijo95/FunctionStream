...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/1.19.2/core/GetDrgRedundancyStatus.ts.html |here} to see how to use GetDrgRedundancyStatusRequest.
 */

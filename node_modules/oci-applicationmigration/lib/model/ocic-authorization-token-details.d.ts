...
export declare namespace OcicAuthorizationTokenDetails {
    function getJsonObj(obj: OcicAuthorizationTokenDetails, isParentJsonObj?: boolean): object;
    const type = "OCIC_IDCS";
}

...
(function (SourceDetails) {
    function getJsonObj(obj) {
        ...
        if ("type" in obj && obj.type) {
            switch (obj.type) {
                case "OCC":
                    return model.OccSourceDetails.getJsonObj(jsonObj, true);
                case "INTERNAL_COMPUTE":
                    return model.InternalSourceDetails.getJsonObj(jsonObj, true);
                case "OCIC":
                    return model.OcicSourceDetails.getJsonObj(jsonObj, true);
                default:

...
export interface UpdateSourceDetails {
    ...
    "authorizationDetails"?: model.OccAuthorizationDetails | model.InternalAuthorizationDetails | model.OcicAuthorizationTokenDetails | model.OcicAuthorizationDetails;
    /**
...
export declare namespace UpdateSourceDetails {
    function getJsonObj(obj: UpdateSourceDetails): object;
}

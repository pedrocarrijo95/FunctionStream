...
export interface FlowNode {
    ...
    "operator"?: model.Joiner | model.TaskOperator | model.Aggregator | model.SortOper | model.Projection | model.EndOperator | model.Source | model.Union | model.Intersect | model.Target | model.Distinct | model.Filter | model.StartOperator | model.MergeOperator | model.Minus;

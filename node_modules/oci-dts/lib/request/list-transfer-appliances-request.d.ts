...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/1.19.2/dts/ListTransferAppliances.ts.html |here} to see how to use ListTransferAppliancesRequest.
 */
...
export declare namespace ListTransferAppliancesRequest {
    enum LifecycleState {
        Requested = "REQUESTED",
